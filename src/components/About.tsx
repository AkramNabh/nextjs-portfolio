...
const About = async () => {
  ...
  return (
    <section className='max-w-7xl h-screen mx-auto p-2 flex flex-col items-center justify-center space-y-24'>
        <h1 className={`text-2xl uppercase tracking-[20px] text-[#007CBE] dark:text-[#C84B31]`}>About</h1>
        <div className='flex flex-col-reverse md:flex-row items-center md:justify-center w-full'>
            <div className='md:w-[70%] w-full'>
                ...
                direction={'left'}
                >
                <div className={`p-4 text-center md:text-left font-semibold text-sm text-[#1E1B18] dark:text-[#FFF9FB]`}>
                ...
                direction={'right'}
                >
                    <div className={`flex items-center justify-center shadow-lg shadow-[#1E1B18] dark:shadow-[#EEEEEE] rounded-lg bg-white dark:bg-[#D65A31] h-[250px] p-2 w-full my-12`}>
                        <div className={`w-full h-full bg-[#FF7F11] dark:bg-[#E5E5E5] rounded-lg hover:scale-105 duration-300`}>
